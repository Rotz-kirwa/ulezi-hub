...
function App() {
  ...
  return (
    <div className="app">
      ...
      <main>
        {activeSection === 'home' && (
          <>
            ...
            <Services setActiveSection={handleSetActiveSection} />
            <WhyChooseUs />
            <Testimonials />
          </>
        )}
        {activeSection === 'services' && <Services detailed setActiveSection={handleSetActiveSection} />}
      ...
      <a href="https://wa.me/254737633532?text=Hello%20Jifunze%20Ulezi%20Hub,%20I%20would%20like%20to%20inquire%20about%20your%20services" target="_blank" rel="noopener noreferrer" className="whatsapp-float" title="Chat with us on WhatsApp">
